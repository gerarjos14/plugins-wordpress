...
define('DESCRIPTION_SII', 'Integración con SII de Chile');
define('DESCRIPTION_SIIGO', 'Servicio de BillConnector para integrar SIIGO a WooCommerce');
define('DESCRIPTION_ALEGRA', 'Servicio de BillConnector para integrar ALEGRA a WooCommerce');
define('DESCRIPTION_SUNAT', 'Servicio de BillConnector para integrar SUNAT a WooCommerce');
define('DESCRIPTION_ANALYTICS', '');
define('DESCRIPTION_PAGUE', '');
...
class BC_Services{
     ...
     * 
     */
    public function upload_services($name, $description){ 
        
        $this->helpers->write_log($description);
        ...
        if(is_null($description)){
            switch($name){
                case 'ANALITYCS': 
                    ...
                    break;
                case 'SIIGO':
                    $description = DESCRIPTION_SIIGO;
                    break;
                case 'ALEGRA':
                    $description = DESCRIPTION_ALEGRA;
                    break;
            }
        }           
            ...
            switch($key){                
                case 'FAC_CHILE':
                    ...
                    if($update_service){
                        ...
                        $this->upload_services($name, DESCRIPTION_SII);
                    }
                    break;
                case 'PAGUE_A_TIEMPO':
                    $name = 'Pague a tiempo';
                    if($update_service){
                        ...
                        $this->upload_services($name, DESCRIPTION_PAGUE);
                    }
                    break;
                case 'FAC_PERU':
                    $name = 'SUNAT';
                    if($update_service){
                        ...
                        $this->upload_services($name, DESCRIPTION_SUNAT);
                    }
