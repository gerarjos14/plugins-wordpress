        ...
        foreach($services as $key){ ?>            
            <div class="col-sm-6">
                <div class="card card-services">
                    ...
                    <hr class="divideer">
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sunt perferendis nostrum, nobis, id magnam amet nam totam neque omnis doloremque provident unde laborum. Ex architecto excepturi tenetur, asperiores cumque facere!</p>
                    <hr class="divideer">
