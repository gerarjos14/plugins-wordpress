        ...
        <div class="col-md-12 col-success-bc">
            <div class="card card-success-bc">
                <div class="card-body">
                    ...
                    <h1>¡Listo! <br class="break-success"> Se ha cargado la información de la tarjeta</h1>
                    <h3> Has cargado la tarjeta *********  {{ $data->card_last_four }}</h3>
                </div>
            </div>
        </div>
                ...
                <div class="card-body text-bc-data-buy">
                    ...
                    <table class="form-table p-2 table-info-buy" id="table-buy-data">
                        <tr>
                            ...
                            <th class="row-title text-bc-data-buy">{{ $data->card_last_four }}</th>
                        </tr>
                        <tr>
                            <th class="row-title text-bc-data-buy">CVC</th>
                            <th class="espacio-width"></th>
                            <th class="row-title text-bc-data-buy">{{ base64_decode($data->cvc) }} </th>
                        </tr>
                        <tr class="espacio"></tr>
                        <tr class="espacio"></tr>
                        <tr>
                            ...
                            <th class="espacio-width"></th>
                            <th class="row-title text-bc-data-buy">{{ $data->card_brand }} </th>
                        </tr>
                        <tr class="espacio"></tr>
                        <tr>
                            <th class="row-title text-bc-data-buy">Fecha de vencimiento</th>
                            <th class="espacio-width"></th>
                            <th class="row-title text-bc-data-buy">{{ base64_decode($data->month)}}/{{base64_decode($data->year) }}</th>
                        </tr>
                    </table>
                </div>
            </div>
