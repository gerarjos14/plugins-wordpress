<html>
	<head>
		...
		<style type="text/css">
			...
			.icon61 img {width: 100px; height: auto;}
	...
	<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full"  bgcolor="#ffffff"style="background-color: #ffffff;">
			<tr>
				<td style="-webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; background-position: center center; background-repeat: no-repeat;">
						...
						<tr>
							...
							<td align="center" width="600" valign="middle">
								...
								<table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="full">
									<tr>
										<td align="center" width="600" valign="middle" bgcolor="#eeeeee"style="background-color: #eeeeee;">
											...
											<div class="sortable_inner ui-sortable">
												...
												<table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile" object="drag-module-small" >
													<tr>
														<td width="600" valign="middle" class="icon61" align="center">
															<table width="550" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
																<tr>
																	{{-- <a href="#"> <img src="{{ $message->embed(public_path().'/images/logo.png') }}" width="150"/></a> <br/> --}}
																</tr>
															</table>
														</td>
													</tr>
													...
													<tr>
														<td width="600" valign="middle">
															...
															<table width="600" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
																...
																<tr>
																	<td width="100%" height="1" bgcolor="#e5e5e5" style="font-size: 1px; line-height: 1px;">&nbsp;</td>
																</tr>
																<tr>
																	<td width="100%" height="10"></td>
																</tr>
																			...
																			<tr>
																				<td align="center" height="35"bgcolor="#fe4646" style="border-top-left-radius: 20px; border-top-right-radius: 20px; border-bottom-right-radius: 20px; border-bottom-left-radius: 20px; padding-left: 30px; padding-right: 30px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); text-transform: uppercase; background-color: rgb(254, 70, 70);">
																					<!--[if !mso]><!--><span style="font-family: 'proxima_nova_rgbold', Helvetica; font-weight: normal;"><!--<![endif]-->
																						<a href="#" style="color: rgb(255, 255, 255); font-size: 14px; text-decoration: none; line-height: 35px; width: 100%;">sign up now!</a>
																					<!--[if !mso]><!--></span><!--<![endif]-->
																				</td>
																			</tr>
																		</table>
							...
							<td width="100%" height="100" align="center">
								<div class="sortable_inner ui-sortable">
									<table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="full" object="drag-module-small">
										<tr> <td width="600" height="40"></td> </tr>
									</table>
									<table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="full" object="drag-module-small">
