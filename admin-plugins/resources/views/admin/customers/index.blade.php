        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex align-items-center ">
                    ...
                    <a href="{{route('admin.customers.create')}}" class="btn btn-sm btn-outline-success"><i class="fas fa-plus mr-1"></i></i>Crear</a>
                </div>
                <div class="card-body">
        ...
        jQuery(document).ready(function() {
            ...
            $('#myTable').DataTable({
                ...
                columns: [
                    {data: 'name'},
                    {data: 'email'},
                    {data: 'company.ecomerce_url'},
                    {data: 'allow_lifetime', className: ['text-center']},
                    {data: 'action'},
                ],
                "language": {
