        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex align-items-center ">
                    <h3 class="card-title mr-2">Listado de licencias</h3>
                    <a href="{{route('admin.licenses.create')}}" class="btn btn-sm btn-outline-success"><i class="fas fa-plus mr-1"></i></i>Crear</a>
                </div>
                <div class="card-body">
    ...
    <script>
        jQuery(document).ready(function() {
            ...
            $('#myTable').DataTable({
                responsive: true,
                autoWidth: false,
                ajax: "{{route('admin.licenses.datatable')}}",
                columns: [
                    {data: 'api_platform'},
                    {data: 'license_code'},
                    {data: 'website'},
