...
class LibroCompraVenta extends \App\Dtes\Sii\Base\Libro
{
    ...
    private function normalizarDetalle(array &$detalle)
    {
        ...
        if ($detalle['MntNeto']===false and $detalle['MntExe']) {
            $detalle['TasaImp'] = \App\Dtes\Sii::getIVA();
            $detalle['MntNeto'] = 0;
            $detalle['MntIVA'] = 0;
        }
    ...
    */
    ...
    public function setCaratula(array $caratula)
    {
        ...
        $this->id = 'DTES_LIBRO_'.$this->caratula['TipoOperacion'].'_'.str_replace('-', '', $this->caratula['RutEmisorLibro']).'_'.str_replace('-', '', $this->caratula['PeriodoTributario']).'_'.date('U');
    }
